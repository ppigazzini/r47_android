...
#define VERSION1                                                               \
  "0.109.03.01b1" // major release . minor release . tracked build . internal OR
                  // un/tracked OR subrelease : Alpha / Beta / RC1
...
#define OPTION_CUBIC_159 //                   // C47 SLVC user function is 159
                         //                   digits internally;  This is needed
                         //                   for 34 digit input accuracy.
#undef OPTION_SQUARE_159 // NOT NEEDED AT ALL // C47 SLVQ user function is 159
                         // digits internally; This NOT needed for 34 digit
                         // input accuracy. Even the worst case quadratic solve
                         // is ok in the standard 75 digits.
#define OPTION_EIGEN_159 //                   // C47 EIGEN user function is 159
                         //                   digits internally; This is needed
                         //                   for 34 digit input accuracy.
#define OPTION_XFN_1000  // NO DM42           // XFN extended 1000 digit math
                         // Functionality; does not work on DM42, due to stack
                         // constraint.
#define OPTION_TVM_FORMULAS //                   // Use analytical formulas
                            //                   where possible
#define OPTION_TVM_NEWTON //                   // Use additional newton raphson
                          //                   in the brent solver for tvm where
                          //                   possible
...
//   #undef  TWO_FILE_PGM  //See CRC ISSUE - Commented this line to force full
//   QSPI generation
//                         //Also change the file here: src/c47-dmcp/qspi_crc.h
//                         for the single file version

// The byte counts are never accurate and depending on build system. Consider
// general info. THESE ARE DMCP COMPILE OPTIONS FOR SINGLE FILE NO QSPI (NOT
// POSSIBLE ANYMORE ON DM42 OLD HARDWARE)
#if !defined(TWO_FILE_PGM) &&                                                  \
    !defined(NEW_HW) //---------THESE ARE THE EXCLUSIONS TO MAKE IT FIT WHILE
                     //NOT USING QSPI ON OLD HARDWARE
...
#define SAVE_SPACE_DM42_9  //  6712 bytes // SHOW (use either old SHOW or VIEW,
                           //  change in code)
#define SAVE_SPACE_DM42_10 //  3136 bytes // C47 programming ... (not complete
                           //  removal but disables it anyway)
#define SAVE_SPACE_DM42_12 //  3288 bytes // SLVC, SLVQ, ELLIPTIC, ZETA, BETA
#define SAVE_SPACE_DM42_12PRIME  // 27208 bytes // ISPRIME, NEXTPRIME, FACTORS,
                                 // EULPHI, MATXFACTOR
#define SAVE_SPACE_DM42_12BESSEL //  5129 bytes // Without BESSEL
#define SAVE_SPACE_DM42_12ORTHO  //  0768 bytes // Without ORTHO MENU
#define SAVE_SPACE_DM42_13GRF    // 17472 bytes // Solver & graphics & stat
                                 // graphics
#define SAVE_SPACE_DM42_13GRF_JM //  7520 bytes // More graphics
#define SAVE_SPACE_DM42_14 //   184 bytes // Load programming sample programs
                           //   testPgms
#define SAVE_SPACE_DM42_15 // 17592 bytes // Without all distributions, i.e.
                           // binomial, cauchy, chi
#define SAVE_SPACE_DM42_16 //  2168 bytes // Without Norml distribution
#define SAVE_SPACE_DM42_20_TIMER //  1232 bytes // Without STOPW
#define SAVE_SPACE_DM42_21_HP35  //   200 bytes // Without config file
                                 //   activations only. Not complete removal.
#define SAVE_SPACE_DM42_22_EDIT1 //  3256 bytes // Without number editing in
                                 //  X-register. Not complete EDIT removal.
#define SAVE_SPACE_DM42_23_EDIT2 //  1560 bytes // Without number and function
                                 //  parameter editing in PEM. Not complete EDIT
                                 //  removal.
#define SAVE_SPACE_DM42_24_PROFILES // 768 bytes // Without any dev profile
                                    // shortcuts, and no JM, RJ & HP35
#undef LONGPRESS_CFG
#undef OPTION_CUBIC_159    //  4080 bytes // C47 SLVC function is 159 digits
                           //  internally
#undef OPTION_SQUARE_159   //  2700 bytes // C47 SLVQ function is 159 digits
                           //  internally
#undef OPTION_EIGEN_159    //  5480 bytes // C47 EINEN function is 159 digits
                           //  internally; note both OPTION_SQUARE_159 &
                           //  OPTION_CUBIC_159 used by OPTION_EIGEN_159
#undef OPTION_XFN_1000     //  4850 bytes // XFN extended 1000 digit math
                           //  Functionality
#undef OPTION_TVM_FORMULAS //  2320 bytes // Use analytical formulas where
                           //  possible
#undef OPTION_TVM_NEWTON //             // Use additional newton raphson in the
                         //             brent solver for tvm where possible
// DECNUMBER_FASTMUL        // manually include or exclude this option in the
// Makefile, DECNUMBER_FASTMUL
#endif // !TWO_FILE_PGM && !NEW_HW

// THESE ARE DMCP COMPILE OPTIONS FOR TWO FILE QSPI
#if defined(TWO_FILE_PGM) //---------THESE ARE THE EXCLUSIONS TO MAKE IT FIT
                          //INTO AVAILABLE FLASH EVEN WHILE USING QSPI
...
#elif DMCP_PACKAGE == 3
#define PACKAGE3_NOBESSEL_NOORTHO_NOFBR // More aggressive removals in addition
                                        // to package 1
#elif DMCP_PACKAGE == 4
#define PACKAGE4_MINIMAL_MATH // Most aggressive removals to pass gitlab
                              // pipeline CI release compiles
#endif
...
//  #define SAVE_SPACE_DM42_14       //   184 bytes // Without Load programming
//  sample programs testPgms #define SAVE_SPACE_DM42_15       // 10056 bytes //
//  Without all distributions, i.e. , cauchy, chi, expo, logis, t, weibull
//  #define SAVE_SPACE_DM42_16       //  2168 bytes // Without Norml
//  distribution #define SAVE_SPACE_DM42_17       //  9840 bytes // Without
//  Poisson/Hyper/Binomial/Geometrical/f distributions
#define SAVE_SPACE_DM42_21_HP35 //     0 bytes // Without config file
                                //     activations only. Not complete removal
#define SAVE_SPACE_DM42_24_PROFILES //   240 bytes // Without any dev profile
                                    //   shortcuts, and no JM, RJ & HP35
#undef OPTION_TVM_FORMULAS //  2280 bytes // Use TVM analytical formulas where
                           //  possible
#undef OPTION_TVM_NEWTON //  1864 bytes // Use TVM additional newton raphson in
                         //  the brent solver for tvm where possible
#endif
...
//  #define SAVE_SPACE_DM42_12ORTHO  //  0744 bytes // Without X.FN ORTHO MENU
//  #define SAVE_SPACE_DM42_14       //   184 bytes // Without Load programming
//  sample programs testPgms
#define SAVE_SPACE_DM42_15 // 10056 bytes // Without all distributions, i.e. ,
                           // cauchy, chi, expo, logis, t, weibull
//  #define SAVE_SPACE_DM42_16       //  2168 bytes // Without Norml
//  distribution
#define SAVE_SPACE_DM42_17 //  9840 bytes // Without
                           //  Poisson/Hyper/Binomial/Geometrical/f
                           //  distributions
//  #define SAVE_SPACE_DM42_21_HP35  //     0 bytes // Without config file
//  activations only. Not complete removal #define SAVE_SPACE_DM42_24_PROFILES//
//  240 bytes // Without any dev profile shortcuts, and no JM, RJ & HP35
#define OPTION_TVM_FORMULAS //  2280 bytes // Use TVM analytical formulas where
                            //  possible
#define OPTION_TVM_NEWTON //  1864 bytes // Use TVM additional newton raphson in
                          //  the brent solver for tvm where possible
#endif
...
#define SAVE_SPACE_DM42_12BESSEL //  5168 bytes // Without X.FN BESSEL
#define SAVE_SPACE_DM42_12ORTHO  //  0744 bytes // Without X.FN ORTHO MENU
#define SAVE_SPACE_DM42_14 //   184 bytes // Without Load programming sample
                           //   programs testPgms
#define SAVE_SPACE_DM42_15 // 10056 bytes // Without all distributions, i.e. ,
                           // cauchy, chi, expo, logis, t, weibull
#define SAVE_SPACE_DM42_16 //  2168 bytes // Without Norml distribution
...
//   #define SAVE_SPACE_DM42_10       //  3136 bytes // Without C47 programming
//   ... (not complete removal but disables it anyway) #define
//   SAVE_SPACE_DM42_12       //  3288 bytes // Without SLVC, SLVQ, ELLIPTIC,
//   ZETA, BETA #define SAVE_SPACE_DM42_12PRIME  // 27208 bytes // Without
//   ISPRIME, NEXTPRIME, FACTORS, EULPHI, MATXFACTOR, NUMTHEORY #define
//   SAVE_SPACE_DM42_13GRF    // 17472 bytes // Without Solver & graphics & stat
//   graphics #define SAVE_SPACE_DM42_13GRF_JM //  7520 bytes // Without More
//   graphics (full plot from memory)
// #define SAVE_SPACE_DM42_20_TIMER //  1232 bytes // Without STOPW
#define SAVE_SPACE_DM42_22_EDIT1 //  3256 bytes // Without number editing in
                                 //  X-register. Not complete EDIT removal.
#define SAVE_SPACE_DM42_23_EDIT2 //  1560 bytes // Without number and function
                                 //  parameter editing in PEM. Not complete EDIT
                                 //  removal.
// #undef  LONGPRESS_CFG            //  1152 bytes // Logic for longpress
// assignment to the f/g key
...
// 2024-11-26 version 00.109.02.06: 9976 bytes to save - 9840 bytes DM42_17 -
// 744 byte DM42_12Ortho = 608 bytes in excess of what's needed

#define TEXT_MULTILINE_EDIT // 5 line buffer
#define MAXLINES                                                               \
  5 // numner of equavalent lines in small font maximum that is allowed in
    // entry. Entry is hardlocked to multiline 3 lines bif font, but this is
    // still the limit. WP has 2 lines fixed small font.
#define allowShowDigits                                                        \
  false // true to allow typing of double digits to get to register number nn in
        // SHOW.
...
// #undef LOW_GRAPH_ACC
#define significantDigitsForEqnGraphs                                          \
  (significantDigits == 0                                                      \
       ? 12                                                                    \
       : significantDigits) // If 6 is chosen by user, all four types are
                            // changes as follows: 34 to SDIGS; 39 to SDIGS+3;
                            // 51 to SDIGS+6; 75 to SDIGS+9
#define significantDigitsForScreen                                             \
  3 // Only for screen coord scaling of the resulting graphic matrix: 34 to 4;
    // 39 to 4+3; 51 to 4+3; 75 to 4+3

// Testing and debugging
#define DM42_KEYCLICK // Add a 1 ms click after key presses and releases, for
                      // scope syncing
#undef DM42_KEYCLICK
...
#define BATTERYTEST // RNG nnnn is used to force the battery voltage in the
                    // simulator
#undef BATTERYTEST
...
// Verbose options
#define VERBOSE_MINIMUM // Minimal simulator key selections, program commands,
                        // refresh modes
...
#define VERBOSEKEYS_AUTOCASE // specifically visualizing the 1 second auto case
                             // indication in sim
...
#define VERBOSE_LEVEL                                                          \
  -1 // JM -1 no text   0 = very little text; 1 = essential text; 2 = extra
     // debugging: on calc screen
...
#define PC_BUILD_VERBOSE2 // JM verbose XEQM detailed operation on PC, via
                          // central jm_show_comment1 function
...
#define NOMATRIXCURSORS // JM allow matrix editing to be navigated by up down
                        // keys
...
// This is to really see what the LCD in the SIM does while programs are
// running. UGLY.
#define FULLUPDATE
// #undef  FULLUPDATE
...
#define BUFFER_KEY_COUNT // dr BUFFER_SIZE has to be at least 8 to become
                         // accurate results
...
#define JM_TO_FN_LONG                                                          \
  400.0 * 0.7 // ms TO_FN_LONG  //  450 on 2020-03-13 //temporary factor set JM
              // 2023-10-14
// New timer constants for FN key double press and longpress
#define TIME_FN_124_F_TO_NOP ((uint32_t)(JM_TO_FN_LONG * 2.0))
#define TIME_FN_1234_F_TO_G                                                    \
  ((uint32_t)(JM_TO_FN_LONG * 2.0)) // temporary factor set JM 2023-10-14
#define TIME_FN_1234_G_TO_NOP                                                  \
  ((uint32_t)(JM_TO_FN_LONG * 1.8)) // temporary factor set JM 2023-10-14
#define TIME_FN_12XX_TO_F                                                      \
  ((uint32_t)(JM_TO_FN_LONG * 1.7)) // temporary factor set JM 2023-10-14
#define TIME_FN_DOUBLE_G_TO_NOP                                                \
  ((uint32_t)(JM_TO_FN_LONG * 1.6)) // temporary factor set JM 2023-10-14
...
// wrapping editor
#define combinationFontsDefault                                                \
  2 // JM 0 = no large font; 1 = enlarged standardfont; 2 = combination font
    // enlargement JM for text wrapping editor. JM Combintionfonts uses large
    // numericfont characters, and if glyph not available then takes
    // standardfont and enlarges it JM Otherwise, full enlarged standardfont is
    // used.
...
#define EXTRA_INFO_ON_CALC_ERROR                                               \
  1 // Print extra information on the console about an error
#define DEBUG_PANEL                                                            \
  0 // Showing registers, local registers, saved stack registers, flags,
    // statistical sums, ... in a debug panel
...
#define MMHG_PA_133_3224                                                       \
  1 // mmHg to Pa conversion coefficient is 133.3224 and not 133.322387415
#define MAX_LONG_INTEGER_SIZE_IN_BITS                                          \
  3328                    // 1001 decimal digits: 3328 ≃ log2(10^1001)
...
#define ENABLE_SOLVER_PROGRESS                                                 \
  1 // Set to 1 to enable solver progress display (only if called in run mode)
#define USE_MICHALSKI_MOSIG_TANH_SINH                                          \
  1 // Set to 1 to use Michalski & Mosig tanh-sinh integration
#define USE_NEW_DEI_INTEGRATION_CODE                                           \
  2 // 0 - use prior code. 1 - use new code. 2 - use new code with split point
    // code.
#define ENABLE_INTEGRATOR_FILE_OUTPUT                                          \
  0 // 1 for PRINTXY to be done after every evaluation of the formula; Or the
    // complex solver for every iteration;
#define ENABLE_COMPLEXSOLVER_FILE_OUTPUT                                       \
  0 // 1 for PRINTXY to be done for the complex solver for every iteration; 2 to
    // print the RPN function; Corrupts Reg_K
#define INTEGRATION_TWO_STAGE_EXIT // If set allows a level to complete before
                                   // exiting the integrator
#undef INTEGRATION_TWO_STAGE_EXIT
#define DECNUMDIGITS                                                           \
  75 // Default number of digits used in the decNumber library
#define BIG_SCREEN_COEF                                                        \
  1 // 2 = 2 times the standard screen, that is 800x480. Can be a decimal
    // like 1.333
#define SIMULATOR_ON_SCREEN_KEYBOARD                                           \
  1 // Set to 0 if you don't want an onscreen keyboard in addition to the screen
#define NARROW_SCREEN 1 // 400x1280 portrait screen
#undef USECURVES        // activate spline curve option in the plot menu
#define XFN_EXTENDED_2PI_FOR_MOD                                               \
  1 // for X_MOD only, if detect precise X_PI 1034 digits, it extends pi to 2139
    // (or as per contxt up to 6147) in XFN only. Needs to by exact, to 0 ULP
    // difference.
...
#define REAL34_WIDTH_TEST                                                      \
  0 // For debugging real34 ALL 0 formating. Use UP/DOWN to shrink or enlarge
    // the available space. The Z register holds the available width.

// Norm_Key_00_VAR, using -1 output for not applicable, purposely out of range
#define Norm_Key_00_key                                                        \
  (calcModel == USER_C47        ? 0                                            \
   : calcModel == USER_DM42     ? 0                                            \
   : calcModel == USER_R47f_g   ? -1                                           \
   : calcModel == USER_R47bk_fg ? 10                                           \
   : calcModel == USER_R47fg_bk ? 11                                           \
                                : -1)
#define Norm_Key_00_keyID                                                      \
  (calcModel == USER_C47        ? 21                                           \
   : calcModel == USER_DM42     ? 21                                           \
   : calcModel == USER_R47f_g   ? -1                                           \
   : calcModel == USER_R47bk_fg ? 35                                           \
   : calcModel == USER_R47fg_bk ? 36                                           \
                                : -1)
#define Norm_Key_00_item_in_layout                                             \
  (calcModel == USER_C47        ? ITM_SIGMAPLUS                                \
   : calcModel == USER_DM42     ? ITM_SIGMAPLUS                                \
   : calcModel == USER_R47f_g   ? -1                                           \
   : calcModel == USER_R47bk_fg ? ITM_NULL                                     \
   : calcModel == USER_R47fg_bk ? ITM_NULL                                     \
                                : -1)
#define isR47FAM                                                               \
  ((bool_t)(calcModel == USER_R47f_g || calcModel == USER_R47bk_fg ||          \
            calcModel == USER_R47fg_bk || calcModel == USER_R47fg_g))

#define shortcutProfile                                                        \
  (calcModel == USER_C47 ? USER_C47 : isR47FAM ? USER_R47 : 0)
#define INTEGERSHORTCUTS                                                       \
  ((calcMode == CM_NIM || calcMode == CM_PEM) &&                               \
   (calcModel == USER_C47 || isR47FAM))

#define isArrowUp(code)                                                        \
  ((isR47FAM && code == 22) || (!isR47FAM && code == 17)) // UP
#define isArrowDown(code)                                                      \
  ((isR47FAM && code == 27) || (!isR47FAM && code == 22)) // DN
#define isShift(code)                                                          \
  ((isR47FAM && code == 10) || (isR47FAM && code == 11) ||                     \
   (!isR47FAM && code == 27)) // All shifts
...
#define STANDARD_FONT_HEIGHT                                                   \
  22 // In Pixel. Used in the font browser application
#define NUMBER_OF_NUMERIC_FONT_LINES_PER_SCREEN                                \
  5 // Used in the font browser application
#define NUMBER_OF_STANDARD_FONT_LINES_PER_SCREEN                               \
  8 // Used in the font browser application

#define AIM_BUFFER_LENGTH                                                      \
  1024 // WP=199 double byte glyphs + trailing 0 + 1 byte to round up to a 4
       // byte boundary; JM increase from WP43 to 512*2 so as to exceed the
       // 508*2+extras;
...
#define ERROR_BAD_INPUT                                                        \
  53 // This error is not in ReM and cannot occur (theoretically).
...
#define NUMBER_OF_SYSTEM_FLAGS                                                 \
  64 + 28 + 6 + 3 // We can have a maximum of 128 system flags
...
#define SETTING_SIOICON                                                        \
  0x0085 // the bit controlling the serial i/o activity icon
...
#define LETTERED_AND_LOCAL_FLAGS_SCREEN                                        \
  5 // Global Lettered Flags and Local FLags screen
...
#define US_ENABLED                                                             \
  (0 << 2) // The command saves the stack, the statistical sums, and the system
           // flags for later UNDO
...
#define US_ENABL_XEQ                                                           \
  (3 << 2) // Like US_STATUS, but if there is not enough memory for UNDO,
           // deletes UNDO data then continue
...
#define CAT_MNUH                                                               \
  (11                                                                          \
   << 4) // Menu, Hidden, not appearing in the catalogue: Hidden menu, eg.
         // 'DEV', accessible with [XEQ] 'OPENM' 'DEV' or [P.FN] [OPENM] 'DEV'
...
#define HG_ENABLED_MX_ONLY                                                     \
  (1 << 13) // Hourglass disabled except when matrixes are in X or Y
#define HG_DISABLED (2 << 13) // Hourglass blocked

// EIM function parameter number - Note, if we need a bit here for more
// important tasks, we can convert this information into an array in equation.c,
// sized [2,22] so no big loss to do.
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
// Register numbering for Register numbering in key the C47 C program: stroke
// programs (one byte) 0…99                                  Global registers
// from 0 to 99                              0…99 100…111 Lettered global
// registers from X to L                          100…111 112…117 Lettered
// global registers from M to S: no possibility of indirect access 211…216
// 118…125         Lettered global registers from E to W: no possibility of
// indirect access         217…224
//                                        25 undefined free registers 225…249
// 126…134                 saved stack registers (UNDO feature) not user
// accessible 135…136                          temporary registers not user
// accessible 137…249              113 undefined free registers: no possibility
// of indirect access
//
//                             SYSTEM_FLAG_NUMBER --> Used for system flag
//                             access                   250
...
enum REG_NUMBERS {           // C program register codes
  ...
  INVALID_VARIABLE = 2199,     // 2199   // Old backup.cfg files will contain
                           // currentInputVariable to be 2043, which is fixed
  ...
  LAST_LOCAL_REGISTER =
      FIRST_LOCAL_REGISTER + 99 - 1 // 7098 total 99 local registers,
};
...
enum REG_NUMBERS_IN_KS_CODE {           // Key Stroke register codes
  ...
  REGISTER_X_IN_KS_CODE =
      FIRST_LETTERED_REGISTER_IN_KS_CODE, // 100 9 stack registers
  ...
  LAST_LOCAL_REGISTER_IN_KS_CODE =
      FIRST_LOCAL_REGISTER_IN_KS_CODE + 99 - 1, // 210, total 99 registers,
...
#define NUMBER_OF_GLOBAL_REGISTERS                                             \
  (LAST_GLOBAL_REGISTER - FIRST_GLOBAL_REGISTER +                              \
   1) // 137 = 100 numbered + 12 lettered + 6 stat + 8 spare + 9 saved_stach + 2
      // temp
#define NUMBER_OF_LETTERED_REGISTERS                                           \
  (LAST_LETTERED_REGISTER - FIRST_LETTERED_REGISTER +                          \
   1) // 12 lettered from X to K
#define NUMBER_OF_STAT_REGISTERS                                               \
  (LAST_STAT_REGISTER - FIRST_STAT_REGISTER + 1) // 6 lettered from M to S
#define NUMBER_OF_SPARE_REGISTERS                                              \
  (LAST_SPARE_REGISTER - FIRST_SPARE_REGISTER + 1) // 8 lettered from E to W
#define NUMBER_OF_SAVED_STACK_REGISTERS                                        \
  (LAST_SAVED_STACK_REGISTER - FIRST_SAVED_STACK_REGISTER + 1) // 9
#define NUMBER_OF_TEMP_REGISTERS                                               \
  (LAST_TEMP_REGISTER - FIRST_TEMP_REGISTER + 1) // 2
#define NUMBER_OF_LOCAL_REGISTERS                                              \
  (LAST_LOCAL_REGISTER - FIRST_LOCAL_REGISTER + 1) // 99 from .00 to .98

#define NUMBER_OF_RESERVED_VARIABLES                                           \
  (LAST_RESERVED_VARIABLE - FIRST_RESERVED_VARIABLE + 1) // 41
#define NUMBER_OF_LETTERED_VARIABLES                                           \
  (FIRST_NAMED_RESERVED_VARIABLE - FIRST_RESERVED_VARIABLE) // 26

#define RBR_INCDEC1 10
#define LAST_GLOBAL_REGISTER_SCREEN                                            \
  LAST_SPARE_REGISTER - modulo(LAST_SPARE_REGISTER, RBR_INCDEC1)
...
static inline int16_t regKStoC(const uint8_t regKS) {
  return (int16_t)regKS -
         (FIRST_STAT_REGISTER_IN_KS_CODE <= regKS &&
          regKS <= LAST_SPARE_REGISTERS_IN_KS_CODE) *
             NUMBER_OF_LOCAL_REGISTERS +
         (FIRST_LOCAL_REGISTER_IN_KS_CODE <= regKS &&
          regKS <= LAST_LOCAL_REGISTER_IN_KS_CODE) *
             (FIRST_LOCAL_REGISTER - FIRST_LOCAL_REGISTER_IN_KS_CODE);
}
...
static inline uint8_t regCtoKS(const int16_t regC) {
  return (
      uint8_t)(regC +
               (FIRST_STAT_REGISTER <= regC && regC <= LAST_SPARE_REGISTER) *
                   NUMBER_OF_LOCAL_REGISTERS -
               (FIRST_LOCAL_REGISTER <= regC && regC <= LAST_LOCAL_REGISTER) *
                   (FIRST_LOCAL_REGISTER - FIRST_LOCAL_REGISTER_IN_KS_CODE));
}

// If one of the 4 next defines is changed: change also Y_POSITION_OF_???_LINE
// below
...
#define TEMPORARY_INFO_OFFSET                                                  \
  6 // Vertical offset for temporary informations. I find 4 looks better
#define REGISTER_LINE_HEIGHT 36

#define Y_POSITION_OF_REGISTER_T_LINE                                          \
  24 // 135 - REGISTER_LINE_HEIGHT*(registerNumber - REGISTER_X)
...
#define X_TIME                                                                 \
  45 // note: this is used only if DATE is not displayed, otherwise TIME is
     // printed directly next to date's end
#define X_REAL_COMPLEX                                                         \
  (X_TIME + 91) // note: this is for both dow or time, not both
#define X_HOURGLASS_GRAPHS (X_REAL_COMPLEX + 4) //
#define X_COMPLEX_MODE (X_HOURGLASS_GRAPHS + 6) //
#define X_COMPLEX_MODE_ADJ                                                     \
  -8 // note: auto moved left if REAL_COMPLEX is not present
...
#define X_SERIAL_IO                                                            \
  (X_STOPWATCH +                                                               \
   18) // note: I/O and Printing (soft or hard) cannot happen at the same time
...
#define DY_BATTERY                                                             \
  20 // >=3.045 V - maximum bars (tip of battery against the edge)
     // f/g icon either in T-line left; or if date or time is removed, it moves
     // up top left; or if SBAR_SHIFT is active, it goes top right, next to U
#define X_SHIFT_L 0
...
#define Y_SHIFT                                                                \
  (((!SBARUPD_Date || !(SBARUPD_Time || SBARUPD_WoY)) && !SBAR_SHIFT)          \
       ? 0                                                                     \
       : (SBAR_SHIFT ? 0 : Y_SHIFT_LO))

#define TIMER_IDX_REFRESH_SLEEP 0 // use timer 0 to wake up for screen refresh
// #define TIMER_IDX_AUTO_REPEAT                    1 // use timer 1 to wake up
// for key auto-repeat
...
#define NUMBER_OF_DISPLAY_REAL_CONTEXT_DIGITS                                  \
  ((displayFormat == DF_ALL || getSystemFlag(FLAG_2TO10))                      \
       ? NUMBER_OF_DISPLAY_DIGITS + 1                                          \
       : displayFormatDigits +                                                 \
             2) // used for time consuming functions, divides, etc.
#define NUMBER_OF_DISPLAY_DIGITS 20
#define NUMBER_OF_DATA_TYPES_FOR_CALCULATIONS 10

#if defined(DMCP_BUILD) &&                                                     \
    defined(OLD_HW)         // The old HW has about 64Kb for user usable RAM
...
#define AC_UPPER 0
#define AC_LOWER 1
#define plainTextMode                                                          \
  (bool_t)(calcMode == CM_AIM ||                                               \
           ((calcMode == CM_PEM || calcMode == CM_ASSIGN) &&                   \
            getSystemFlag(FLAG_ALPHA)))
#define labelText                                                              \
  (bool_t)((tam.mode == TM_MENU || tam.mode == TM_LABEL ||                     \
            tam.mode == TM_LBLONLY || tam.mode == TM_STORCL || tam.alpha) &&   \
           getSystemFlag(FLAG_ALPHA))
// #define plainText                                  (bool_t)( calcMode ==
// CM_AIM   || calcMode == CM_EIM    || (calcMode == CM_PEM    &&
// getSystemFlag(FLAG_ALPHA) && !tam.mode))
...
#define NP_COMPLEX_FRACTION_DENOMINATOR                                        \
  11 // Denominator of the complex imaginary part fraction
#define NP_COMPLEX_HP32SII_DENOMINATOR                                         \
  12 // Denominator of the complex imaginary part fraction (HP32SII mode)
...
#define SET_TI_TRUE_FALSE(condition)                                           \
  do {                                                                         \
    temporaryInformation = TI_FALSE + (condition);                             \
  } while (0) // TI_TRUE must be TI_FALSE + 1
...
// Statistical sums TODO: optimize size of SIGMA_N, _X, _Y, _XMIN, _XMAX, _YMIN,
// and _YMAX. Thus, saving 2×(7×60 - 4 - 6×16) = 640 bytes
#define SUM_X 1
#define SUM_Y 2
#define SUM_X2 3
#define SUM_X2Y 4
...
#define SIGMA_N                                                                \
  (statisticalSumsPointer) // could be a 32 bit unsigned integer. No, this must
                           // be old. SIGMA_N is a Real.
#define SIGMA_X                                                                \
  (statisticalSumsPointer +                                                    \
   SUM_X) // could be a real34. No, this must be old. SIGMA_** is a Real.
#define SIGMA_Y                                                                \
  (statisticalSumsPointer +                                                    \
   SUM_Y) // could be a real34. No, this must be old. SIGMA_** is a Real.
...
#define SIGMA_XMIN                                                             \
  (statisticalSumsPointer +                                                    \
   SUM_XMIN) // could be a real34. No, this must be old. SIGMA_** is a Real.
#define SIGMA_XMAX                                                             \
  (statisticalSumsPointer +                                                    \
   SUM_XMAX) // could be a real34. No, this must be old. SIGMA_** is a Real.
#define SIGMA_YMIN                                                             \
  (statisticalSumsPointer +                                                    \
   SUM_YMIN) // could be a real34. No, this must be old. SIGMA_** is a Real.
#define SIGMA_YMAX                                                             \
  (statisticalSumsPointer +                                                    \
   SUM_YMAX) // could be a real34. No, this must be old. SIGMA_** is a Real.

#define MAX_NUMBER_OF_GLYPHS_IN_STRING                                         \
  508 // WP=196: Change to 512 less 3, Also change error message 33, and
      // AIM_BUFFER_LENGTH, and MAXLINES
...
#define MAX_DENMAX                                                             \
  9999 // Biggest denominator in fraction display mode selector, and
       // annunciator. The value 0 gets converted to MAX_INTERNAL_DENMAX
#define MAX_INTERNAL_DENMAX                                                    \
  32500 // Biggest denominator in fraction display mode

#if defined(DMCP_BUILD)
#define SCREEN_REFRESH_PERIOD                                                  \
  160 // 500 // in milliseconds //JM timeout for lcd refresh in ms 125
#define FAST_SCREEN_REFRESH_PERIOD 100 // in milliseconds
#else                                  // !DMCP_BUILD
#define SCREEN_REFRESH_PERIOD                                                  \
  100 // 500 // in milliseconds //JM timeout for lcd refresh in ms 100
#define FAST_SCREEN_REFRESH_PERIOD 100  // in milliseconds
#endif                                  // DMCP_BUILD
...
#define RAM_SIZE_IN_BLOCKS_OLD_HW                                              \
  (16384) // MUST be < 2^16 - 1   (65535 = 0xffff excluded because it's the
          // value of the C47_NULL pointer)
#define RAM_SIZE_IN_BLOCKS_NEW_HW                                              \
  (65534) // MUST be < 2^16 - 1   (65535 = 0xffff excluded because it's the
          // value of the C47_NULL pointer)
...
#define IS_EQN_INTEGRATE                                                       \
  (((currentSolverStatus & SOLVER_STATUS_EQUATION_MODE) ==                     \
    SOLVER_STATUS_EQUATION_INTEGRATE) &&                                       \
   currentSolverStatus & SOLVER_STATUS_INTERACTIVE)
#define IS_EQN_2NDDER                                                          \
  ((currentSolverStatus & SOLVER_STATUS_USES_FORMULA) &&                       \
   (currentSolverStatus & SOLVER_STATUS_INTERACTIVE) &&                        \
   ((currentSolverStatus & SOLVER_STATUS_EQUATION_MODE) ==                     \
    SOLVER_STATUS_EQUATION_2ND_DERIVATIVE))
#define IS_EQN_1STDER                                                          \
  ((currentSolverStatus & SOLVER_STATUS_USES_FORMULA) &&                       \
   (currentSolverStatus & SOLVER_STATUS_INTERACTIVE) &&                        \
   ((currentSolverStatus & SOLVER_STATUS_EQUATION_MODE) ==                     \
    SOLVER_STATUS_EQUATION_1ST_DERIVATIVE))
...
#define ASSIGN_RESERVED_VARIABLES                                              \
  (ASSIGN_NAMED_VARIABLES + FIRST_RESERVED_VARIABLE - FIRST_NAMED_VARIABLE)
...
//******************************
#if (EXTRA_INFO_ON_CALC_ERROR == 0) || defined(TESTSUITE_BUILD) ||             \
    defined(DMCP_BUILD)
...
#define EXTRA_INFO_MESSAGE(function, msg)                                      \
  do {                                                                         \
    ...
    moreInfoOnError("In function ", function, errorMessage, NULL);             \
  } while (0)
#endif // EXTRA_INFO_ON_CALC_ERROR == 0 || TESTSUITE_BUILD || DMCP_BUILD

#define isSystemFlagWriteProtected(sf) ((sf & 0x4000) != 0)
#define shortIntegerIsZero(op)                                                 \
  (((*(uint64_t *)(op)) == 0) ||                                               \
   (shortIntegerMode == SIM_SIGNMT &&                                          \
    (((*(uint64_t *)(op)) == 1u << ((uint64_t)shortIntegerWordSize - 1)))))
#define getStackTop() (getSystemFlag(FLAG_SSIZE8) ? REGISTER_D : REGISTER_T)
#define freeRegisterData(regist)                                               \
  freeC47Blocks(getRegisterDataPointer(regist),                                \
                getRegisterFullSizeInBlocks(regist))
...
#define TO_C47MEMPTR(p)                                                        \
  ((p) == NULL ? C47_NULL : (uint16_t)((uint32_t *)(p) - ram))

#define min(a, b) ((a) < (b) ? (a) : (b))
#define max(a, b) ((a) > (b) ? (a) : (b))
#define rmd(n, d)                                                              \
  ((n) % (d)) // rmd(n,d) = n - d*idiv(n,d)   where idiv is the division with
              // decimal part truncature
#define mod(n, d)                                                              \
  (((n) % (d) + (d)) % (d)) // mod(n,d) = n - d*floor(n/d)  where floor(a) is
                            // the biggest integer <= a
// #define modulo(n, d)                         ((n)%(d)<0 ? ((d)<0 ? (n)%(d) -
// (d) : (n)%(d) + (d)) : (n)%(d)) // modulo(n,d) = rmd(n,d) (+ |d| if
// rmd(n,d)<0)  thus the result is always >= 0
#define modulo(n, d)                                                           \
  ((n) % (d) < 0 ? (n) % (d) + (d)                                             \
                 : (n) % (d)) // This version works only if d > 0
#define nbrOfElements(x) (sizeof(x) / sizeof((x)[0])) // dr

#define PROBMENU showingProbMenu()

#define BASEMODEACTIVE                                                         \
  (!PROBMENU &&                                                                \
   (lastIntegerBase != 0 ||                                                    \
    softmenu[softmenuStack[0].softmenuId].menuItem == -MNU_BASE ||             \
    dispBase > 0))

#define XXFNMODEACTIVE                                                         \
  (!SHOWMODE && !GRAPHMODE &&                                                  \
   softmenu[softmenuStack[0].softmenuId].menuItem == -MNU_XXFCNS &&            \
   calcMode != CM_NIM &&                                                       \
   ((getRegisterDataType(REGISTER_X) == dtReal34 ||                            \
     getRegisterDataType(REGISTER_X) == dtLongInteger) ||                      \
    (getRegisterDataType(REGISTER_T) == dtReal34 ||                            \
     getRegisterDataType(REGISTER_T) == dtLongInteger)))
// PROBMENU not needed, as a specific menu is required for XXFN

#define DBASEMODE                                                              \
  (!SHOWMODE && !GRAPHMODE && !PROBMENU && !XXFNMODEACTIVE && dispBase >= 2)

#define BASEMODEREGISTERX                                                      \
  (BASEMODEACTIVE && displayStackSHOIDISP != 0 &&                              \
   ((calcMode == CM_NORMAL &&                                                  \
     getRegisterDataType(REGISTER_X) == dtShortInteger) ||                     \
    (calcMode == CM_NIM &&                                                     \
     getRegisterDataType(REGISTER_Y) == dtShortInteger) ||                     \
    (calcMode == CM_NORMAL &&                                                  \
     getRegisterDataType(REGISTER_X) == dtLongInteger)))
#define inputAngleMode3r(r)                                                    \
  ((registerIsNoAngle(r + 1) && registerIsNoAngle(r + 2))                      \
       ? (!registerIsNoAngle(r) ? getRegisterAngularMode(r) : amNone)          \
       : amNone)
#define registerIsNoAngle(r)                                                   \
  ((getRegisterDataType(r) == dtReal34 &&                                      \
    getRegisterAngularMode(r) == amNone) ||                                    \
   getRegisterDataType(r) == dtLongInteger)
#define inputIsNoAngle3r(r)                                                    \
  (registerIsNoAngle(r) || !registerIsNoAngle(r + 1) ||                        \
   !registerIsNoAngle(r + 2))
#define inputAngleError3r(r)                                                   \
  (!registerIsNoAngle(r + 1) || !registerIsNoAngle(r + 2))
#define isXFNregisterValid3r(r)                                                \
  ((getRegisterDataType(r) == dtReal34 ||                                      \
    getRegisterDataType(r) == dtLongInteger) &&                                \
   (getRegisterDataType(r + 1) == dtReal34 ||                                  \
    getRegisterDataType(r + 1) == dtLongInteger) &&                            \
   (getRegisterDataType(r + 2) == dtReal34 ||                                  \
    getRegisterDataType(r + 2) == dtLongInteger) &&                            \
   !inputAngleError3r(r))
#define isXFNShowing(r)                                                        \
  (menu(0) == -MNU_SHOW && menu(1) == -MNU_XXFCNS && isXFNregisterValid3r(r))

#define SHOWMODE                                                               \
  (calcMode == CM_NORMAL && (temporaryInformation == TI_SHOW_REGISTER ||       \
...
#define COMPLEX_UNIT                                                           \
  (getSystemFlag(FLAG_CPXj)                                                    \
       ? STD_op_j                                                              \
       : STD_op_i) // Do not change back to single byte character - code must
                   // also change accordingly
#define PRODUCT_SIGN (getSystemFlag(FLAG_MULTx) ? STD_CROSS : STD_DOT)

#define RADIX34_MARK_CHAR                                                      \
  (gapChar1Radix[0] == ',' || (gapChar1Radix[0] == STD_WCOMMA[0] &&            \
                               gapChar1Radix[1] == STD_WCOMMA[1])              \
       ? ','                                                                   \
       : '.') // map comma and wide comma to comma, and dot and period and wdot
              // and wperiod to period
#define RADIX34_MARK_STRING (gapChar1Radix)
#define RADIX34_MARK_DEC_ITM (RADIX34_MARK_CHAR == '.' ? ITM_PERIOD : ITM_COMMA)
#define RADIX34_MARK_NOT_DEC_ITM                                               \
  (RADIX34_MARK_CHAR == '.' ? ITM_COMMA : ITM_PERIOD)

#define groupingGap                                                            \
  ((uint8_t)(grpGroupingLeft)) // ADD HERE THE CONDITIONS FOR NIL SEPS

#define Lt                                                                     \
  (gapItemLeft == 0 ? (char *)"\1\1\0"                                         \
                    : (char *)indexOfItems[gapItemLeft]                        \
                          .itemSoftmenuName) // Actual separator character
#define Rt                                                                     \
  (gapItemRight == 0 ? (char *)"\1\1\0"                                        \
                     : (char *)indexOfItems[gapItemRight]                      \
                           .itemSoftmenuName) // Actual separator character
#define Rx                                                                     \
  ((char *)indexOfItems[gapItemRadix]                                          \
       .itemSoftmenuName) // Actual separator character
#define gapChar1Left                                                           \
  (Lt[0] != 0 && Lt[1] == 0 && Lt[2] == 0                                      \
       ? (Lt[0] == ','    ? (char *)",\1\0"                                    \
          ...
          : Lt[0] == '_'  ? (char *)"_\1\0"                                    \
                          : Lt)                                                 \
       : Lt) // set second character to skip character 0x01
#define gapChar1Right                                                          \
  (Rt[0] != 0 && (Rt[1] == 0 || (Rt[1] != 0 && Rt[2] == 0))                    \
       ? (Rt[0] == ','    ? (char *)",\1\0"                                    \
          : Rt[0] == '.'  ? (char *)".\1\0"                                    \
          : Rt[0] == '\'' ? (char *)"\'\1\0"                                   \
          : Rt[0] == '_'  ? (char *)"_\1\0"                                    \
                          : Rt)                                                 \
       : Rt) // set second character to skip character 0x01
#define gapChar1Radix                                                          \
  (Rx[0] != 0 && (Rx[1] == 0 || (Rx[1] != 0 && Rx[2] == 0))                    \
       ? (Rx[0] == ','   ? (char *)",\1\0"                                     \
          : Rx[0] == '.' ? (char *)".\1\0"                                     \
                         : Rx)                                                 \
       : Rx) // set second character to skip character 0x01
...
#define gapItemFrac                                                            \
  (gapItemLeft == 0 ? 0 : ITM_SPACE_4_PER_EM) // Fractions only get to have
                                              // narrow space or nothing
#define SEPARATOR_FRAC                                                         \
  (gapItemFrac == 0 ? (char *)"\1\1\0"                                         \
                    : (char *)indexOfItems[gapItemFrac]                        \
                          .itemSoftmenuName) // Actual separator character
...
#ifdef REPLACEFONT
#define DOUBLING_A                                                             \
  15u // 16=is double; 14 is 1.75*; 12=1.5*; 10=1.25* (8 is the per unit norm
      // horizontal factor, A/B)
...
#else
#define DOUBLING_A                                                             \
  14u // 16=is double; 14 is 1.75*; 12=1.5*; 10=1.25* (8 is the per unit norm
      // horizontal factor, A/B)
#define DOUBLINGBASE_B 8u
...
#define GROUPWIDTH_LEFT1                                                       \
  ((grpGroupingGr1Left == 0 ? (uint16_t)grpGroupingLeft                        \
                            : (uint16_t)grpGroupingGr1Left))
#define GROUPWIDTH_LEFT1X (grpGroupingGr1LeftOverflow)
#define GROUP1_OVFL(digitCount, exp)                                           \
  ((grpGroupingGr1LeftOverflow > 0 && exp == GROUPWIDTH_LEFT1 &&               \
            digitCount + 1 == GROUPWIDTH_LEFT1                                 \
        ? grpGroupingGr1LeftOverflow                                           \
        : 0))
#define GROUPWIDTH_RIGHT (grpGroupingRight)
#define SEPARATOR_(digitCount)                                                 \
  (digitCount >= 0 ? SEPARATOR_LEFT : SEPARATOR_RIGHT)
#define GROUPWIDTH_(digitCount)                                                \
  (digitCount >= 0 ? GROUPWIDTH_LEFT : GROUPWIDTH_RIGHT)
#define digitCountNEW(digitCount)                                              \
  (digitCount + 1 > GROUPWIDTH_LEFT1                                           \
       ? digitCount - GROUPWIDTH_LEFT1                                         \
       : digitCount) // remaining digits to divide up into groups. "+1" due to
                     // the fact the the digit is recognized now, but only added
                     // below. So the sep gets added before the digit down
                     // below.
#define IS_SEPARATOR_(digitCount)                                              \
  ((digitCount + 1 == GROUPWIDTH_LEFT1) ||                                     \
   ((digitCount + 1 > GROUPWIDTH_LEFT1 || digitCount < 0) &&                   \
    (modulo(digitCountNEW(digitCount), (uint16_t)GROUPWIDTH_(digitCount)) ==   \
     (uint16_t)GROUPWIDTH_(digitCount) - 1)))
...
#define IS_SIM_ARROW_ALLOWED_IN_MENU(menu, key)                                \
  ((menu == -MNU_ALPHA && (key == GDK_KEY_Up || key == GDK_KEY_Down ||         \
                           key == GDK_KEY_Left || key == GDK_KEY_Right)) ||    \
   (menu == -MNU_M_EDIT && (key == GDK_KEY_Up || key == GDK_KEY_Down ||        \
                            key == GDK_KEY_Left || key == GDK_KEY_Right)) ||   \
   (menu == -MNU_EQ_EDIT && (key == GDK_KEY_Left || key == GDK_KEY_Right)))

#define IS_BASEBLANK_(menuId)                                                  \
  (menuId == 0 && !getSystemFlag(FLAG_BASE_MYM) &&                             \
   !getSystemFlag(FLAG_BASE_HOME))

#define currentReturnProgramNumber                                             \
  (currentSubroutineLevelData->returnProgramNumber)
#define currentReturnLocalStep (currentSubroutineLevelData->returnLocalStep)
#define currentNumberOfLocalFlags                                              \
  (currentSubroutineLevelData->numberOfLocalFlags)
#define currentNumberOfLocalRegisters                                          \
  (currentSubroutineLevelData->numberOfLocalRegisters)
...
#define currentPtrToPreviousLevel                                              \
  (currentSubroutineLevelData->ptrToPreviousLevel)

#define LOCAL_FLAGS_AFTER_SUBROUTINE_LEVEL_HEADER(ptr)                         \
  ((localFlags_t *)((subroutineLevelHeader_t *)ptr + 1))
#define LOCAL_REGISTER_HEADERS_AFTER_LOCAL_FLAGS(ptr)                          \
  ((registerHeader_t *)((localFlags_t *)ptr + 1))
#define REAL34_MATRIX_ELEMENTS_AFTER_MATRIX_HEADER(ptr)                        \
  ((real34_t *)((matrixHeader_t *)ptr + 1))
#define COMPLEX34_MATRIX_ELEMENTS_AFTER_MATRIX_HEADER(ptr)                     \
  ((real34_t *)((matrixHeader_t *)ptr + 1))

#define isMatrix2dVector(rows, cols)                                           \
  ((rows == 1 && cols == 2) || (rows == 2 && cols == 1))
#define isMatrix3dVector(rows, cols)                                           \
  ((rows == 1 && cols == 3) || (rows == 3 && cols == 1))
#define isMatrixVector(rows, cols)                                             \
  ((isMatrix3dVector(rows, cols) || isMatrix2dVector(rows, cols)))
...
#define is3dVectorPolarSPH(tag)                                                \
  (((getTagAngularMode(tag)) != amNone) && is3dVectorPolarSPHCYL(tag))
#define is3dVectorPolarCYL(tag)                                                \
  (((getTagAngularMode(tag)) != amNone) && !is3dVectorPolarSPHCYL(tag))

#define isMatrix3dVectorSPH(rows, cols, tag)                                   \
  (isMatrix3dVector(rows, cols) && is3dVectorPolarSPH(tag))
#define isMatrix3dVectorCYL(rows, cols, tag)                                   \
  (isMatrix3dVector(rows, cols) && is3dVectorPolarCYL(tag))
#define isMatrix2dVectorPOL(rows, cols, tag)                                   \
  (isMatrix2dVector(rows, cols) && is2dVectorPolar(tag))

#if defined(DMCP_BUILD)
#define runningOnSimOrUSB                                                      \
  getSystemFlag(FLAG_USB) // used to compromise on complexity to increase speed
#else                     //! DMCP_BUILD
#define runningOnSimOrUSB true
#endif //! DMCP_BUILD

#if !defined(PC_BUILD) && !defined(DMCP_BUILD) && !defined(ANDROID_BUILD)
#error One of PC_BUILD, DMCP_BUILD or ANDROID_BUILD must be defined
#endif // !PC_BUILD && !DMCP_BUILD && !ANDROID_BUILD
...
#define ignoreReturnedValue(function)                                          \
  (__extension__({                                                             \
    __typeof__(function) __x = (function);                                     \
    (void)__x;                                                                 \
  }))
...
#define debugf(a)                                                              \
  do {                                                                         \
    fprintf(stderr, "%sdebug:%s %s %s(%s %s:%d)%s\n", COLOR_GREEN, a,          \
            COLOR_DEFAULT, COLOR_CYAN, __FUNCTION__, __FILE__, __LINE__,       \
            COLOR_DEFAULT);                                                    \
    fflush(stderr);                                                            \
  } while (0)
#define errorf(a)                                                              \
  do {                                                                         \
    fprintf(stderr, "%serror:%s %s %s(%s %s:%d)%s\n", COLOR_YELLOW, a,         \
            COLOR_DEFAULT, COLOR_CYAN, __FUNCTION__, __FILE__, __LINE__,       \
            COLOR_DEFAULT);                                                    \
    fflush(stderr);                                                            \
  } while (0)
#define abortf(a)                                                              \
  do {                                                                         \
    fprintf(stderr, "%sabort: %s(%s %s:%d)%s\n", COLOR_RED, COLOR_CYAN,        \
            __FUNCTION__, __FILE__, __LINE__, COLOR_DEFAULT);                  \
    perror(a);                                                                 \
    fflush(stderr);                                                            \
    abort();                                                                   \
  } while (0)
#define userAbort(a)                                                           \
  do {                                                                         \
    fprintf(stderr, "%serror:%s %s \n", COLOR_YELLOW, a, COLOR_DEFAULT);       \
    fflush(stderr);                                                            \
  } while (0)

// To time a piece of code (not on DM42 hardware), you can use the following
// code snippet: struct timespec stopwatch_start, stopwatch_stop;
// clock_gettime(CLOCK_PROCESS_CPUTIME_ID, &stopwatch_start);
// : piece of code
// : to time
// clock_gettime(CLOCK_PROCESS_CPUTIME_ID, &stopwatch_stop);
// printf("Duration = %11.6fs\n", stopwatch_stop.tv_sec + stopwatch_stop.tv_nsec
// /1e9 - stopwatch_start.tv_sec - stopwatch_start.tv_nsec /1e9);
  ...
  do {                                                                         \
    if (globalRegister[r].dataPointer >= 500) {                                \
      ...
      printf("\n=====> BAD  REGISTER %d DATA POINTER: %u <===== %s\n", r,      \
             globalRegister[r].dataPointer, comment);                          \
...
#define PRINT_LI_REG(reg, comment)                                             \
  do {                                                                         \
    ...
    if (getRegisterLongIntegerSign(reg) == LI_ZERO)                            \
      ...
      printf("lint=+");                                                        \
    for (i = *REGISTER_DATA_MAX_LEN(reg) / LIMB_SIZE,                          \
        p = REGISTER_LONG_INTEGER_DATA(reg);                                   \
         i > 0; i--, p++) {                                                    \
      printf("%lu ", *p);                                                      \
    }                                                                          \
